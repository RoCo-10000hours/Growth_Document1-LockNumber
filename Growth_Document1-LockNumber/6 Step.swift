...
// //personal project #1 (SwiftUI 학습 1주차)
...
//            Text("\(resultString)")
            ...
            case 4:
                VStack {
                    AsyncImage(url: URL(string: "https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FbPmndL%2Fbtq1V2o0USb%2FKnW34zpj78VoBvflQiWkWK%2Fimg.png")) { image in
                        image.resizable()
                    } placeholder: {
                        ProgressView()
                    }
...
//여기까지가 1주차 SwiftUI 학습 결과물
//(추가수정) 사용자의 편의를 위해 숫자 클릭picker부분을 아래로내림
//personal project #1
